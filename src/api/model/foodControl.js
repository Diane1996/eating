module.exports = class extends think.Model {
  selectAllOrderMenu(orderId) {
    ...
    const sql = "select * from eating_food as a where (select food_id order_id from eating_order_item as b where a.food_id = b.food_id and b.order_id = '" + orderId + "')";
